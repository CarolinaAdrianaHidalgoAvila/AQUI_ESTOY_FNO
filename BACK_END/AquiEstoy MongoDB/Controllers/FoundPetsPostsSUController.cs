...
namespace AquiEstoy_MongoDB.Controllers
{
    ...
    {
        private IFoundPetSUPostService _foundPetsSUPostsService;

        public FoundPetsSUPostsController(IFoundPetSUPostService foundPetSUPostService)
        {
        ...
        public async Task<ActionResult<IEnumerable<FoundPetPostModel>>> GetFoundPetsSUPosts()
        {
            try
            {
                return Ok(await _foundPetsPostsSUService.GetAllFoundPetsSUPostsAsync());
            }
